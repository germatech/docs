...
[Labeeb](https://app.geramantix.com) can now easily interact with 1000+ apps thanks to Zapier.

## Zapier to send Telegram messages

In this example, we will use Zapier to send a message to a Telegram channel when a new task is created in Labeeb.
...
<Step title="Create a brain as API">
    ...
    <ParamField path="message" type="string">
        message to be sent. By Default the value is a 'Hello, World! This is Labeeb' else add what the user tells you to.
    </ParamField>
</Step>
