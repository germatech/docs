...
title: Ollama
---
The guide was put together in collaboration with members of the Labeeb Discord, **Using Labeeb fully locally** thread. That is a good place to discuss it.
...
## Add Ollama Model to Labeeb

Now that you have your model running locally, you need to add it to Labeeb.

In order to allow the user to choose between the  Ollama, we need to add a new model to the Labeeb backend.
