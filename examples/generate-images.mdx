...
You can use Labeeb to Generate Images using Dall-E 3 from OpenAI or any other API based image generation tool.
...
<Info>
In order to have image generation in Labeeb we will create a brain that is connected to an API. You can find more info on this types of brains [here](/getting-started/api-based-brains)
</Info>
...
<Step title="Create a new Brain">
    Go to the [Brains](https://app.geramantix.com/brains-management) page and click on `Create Brain`
</Step>
...
Don't hesitate to share your creations on [Twitter]().
