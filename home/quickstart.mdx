...
Labeeb is a **knowledge management** tool that allows you to **store** and **search** your knowledge.

<Frame  caption="Labeeb Homepage">
  <img src="/images/homepage.png" alt="Labeeb"/>
</Frame>


## How can you leverage Labeeb ? 🚀

You can use Labeeb to:

<AccordionGroup>
<Accordion title="Search in files" icon="searchengin">
  Labeeb allows you to easily ask questions about your files
</Accordion>
...
<AccordionGroup>
  ...
  A public brain is a brain that is searchable by everyone on Labeeb. You can make a brain public by clicking on the **public** button on the brain page.
  </Accordion>
...
Labeeb is designed to answer your questions by leveraging the knowledge that you've uploaded to it. Here's how you can ask questions:

<Steps>
<Step title="Access Labeeb" icon="searchengin">
  Go to [Labeeb](https://app.geramantix.com) and login to your account.
</Step>
<Step title="Select a Brain" icon="database">
  Select the brain you want to ask a question to. A brain in Labeeb is a knowledge base that you or someone else has created. If you haven't created a brain yet, you'll need to do that first.
</Step>
...
<Step title="Wait for the Answer" icon="clock">
  Labeeb will process your question and provide an answer. The time it takes to get an answer will depend on the complexity of your question and the size of the brain you're asking.
</Step>
</Steps>

Remember, Labeeb is only as smart as the knowledge you've given it. If it doesn't know the answer to a question, consider adding more information to your brain.

### Custom Personality 

You can **customize** the personality of Labeeb by changing the **prompt** of your brain. You could tell your brain to always answer with a **funny** or **serious** tone or act like a **robot** or a **human**.

To customize the prompt of your brain in Labeeb, you would typically follow these steps:
<Steps>
