...
You can find everything on the [documentation](https://docs.geramantix.com/).
...
- **Step 1**: Clone the repository:
  ...
  ```bash
  git clone https://github.com/germatech/labeeb.git && cd labeeb
  ```
...
- **Step 5**: Login to the app
  ...
  You can access Labeeb backend API at [http://localhost:5050/docs](http://localhost:5050/docs)
